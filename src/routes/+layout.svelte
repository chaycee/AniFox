			...
			<div class="flex items-center space-x-2">
				...
				<div class=" hidden sm:block sm:relative top-16 sm:top-0 " id="search-input">
					<form onsubmit="return false;">
						...
						>
							<svg
								class="hi-solid hi-search inline-block w-5 h-5 fill-black stroke-current stroke-3"
								fill="black"
								viewBox="0 0 20 20"
								xmlns="http://www.w3.org/2000/svg"
								aria-hidden="true"
						...
						<input
							type="text"
							class="sm:w-96 w-full block border-2  bg-[#d9d9d9] border-gray-500 rounded-md pl-8 py-3 leading-5 text-sm placeholder-gray-500 text-black focus:border-accent  focus:bg-gray-100 focus:ring-accent focus:ring-opacity-50 "
							id="search"
							name="search"
