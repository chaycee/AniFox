...
<!-- Warning Alert -->
<div class="p-4 md:p-5 rounded text-orange-700 z-100  bg-orange-100" id='alert'>
	<div class="flex items-center">
	  ...
	  <h3 class="font-semibold grow">
		Currently website is under development, this is a preview of the homepage.
	  </h3>
	  <button type="button" on:click={alert} class="inline-flex justify-center items-center space-x-2 rounded border font-semibold focus:outline-none ml-3 px-2 py-1 leading-5 text-sm border-transparent text-red-600 hover:text-red-400 focus:ring focus:ring-red-500 focus:ring-opacity-50 active:text-red-600 ">
		<svg class="hi-solid hi-x inline-block w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
	  </button>
	</div>
  </div>
  <!-- END Warning Alert -->
			...
			<SplideSlide class="flex items-end ">
				...
				>
					...
					<div class="px-5 py-2 xl:p-6 grow lg:w-[800px] h-20 text-left xl:mb-3">
						<div
							class=" pb-1  xl:pb-1 text-left line-clamp-3 lg:line-clamp-3 font-extralight xl:line-clamp-4"
						>
	...
	<section class="space-y-6 px-2 xl:px-0">
		...
		<nav class="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8 ">
			...
			{#each trending.results as card}
				...
				>
					<img
						class="object-fill h-[140%] opacity-100"

						src="https://images.weserv.nl/?url=cors.proxy.consumet.org/{card.image}&output=webp&w=456&af"
