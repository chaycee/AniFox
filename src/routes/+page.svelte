...
<section class="space-y-6 ">
	<div class="flex items-center justify-between">
		<h2 class="dark:text-slate-200 font-semibold text-xl">Trending Anime</h2>
		<a
			...
			>
				...
				>
					...
					<div class="px-4 py-5 flex items-end justify-between space-x-2">
						...
						<div
							class="flex absolute right-3 items-center justify-center w-10 h-10 rounded-full transition text-slate-400 bg-slate-500/25 group-hover:bg-indigo-500 group-hover:text-white group-hover:scale-110 group-active:scale-100"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 20 20"
